...
if __name__ == '__main__':
    ...
    parser.add_argument('--iter_num', type=int, default=4) # Total_timestep = iter_num * n_envs * n_steps, here is 2000 * 4 * 20480 = 1.2e7
    parser.add_argument('--seed', type=int, default=5)
    parser.add_argument('--learning_rate', type=float, default=7.3e-4)
